'''Crea un metodo eliminar(valor) que busque un nodo de la lista y lo elimine.
Si no existe, debe mostrar un mensaje indicando que el valor no se encuentra.'''
...
def main():
    ...
    while True:
        ...
        if opcion == 1:
            ...
            print("Introduce el valor a eliminar: ")
            valores = int(input())
            lista.eliminar(valores)
        elif opcion == 6:
